...
def upgrade() -> None:
    ...
    op.create_index('idx_progress_user_updated', 'playback_progress', ['user_id', 'updated_at'], unique=False)
    op.create_index(op.f('ix_playback_progress_job_id'), 'playback_progress', ['job_id'], unique=False)
