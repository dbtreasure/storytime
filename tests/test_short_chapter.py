...
async def main():
    ...
    try:
        ...
        if chapter and chapter.segments:
            ...
            complete_audio_output = SCRIPT_DIR.parent / "output" / f"{provider_choice}-{args.model}" / f"chapter_01_complete.mp3"
            individual_files_output = SCRIPT_DIR.parent / "output" / f"{provider_choice}-{args.model}" / f"chapter_01"
            playlist_output = SCRIPT_DIR.parent / "output" / f"{provider_choice}-{args.model}" / f"chapter_01" / "chapter_01_playlist.m3u"
